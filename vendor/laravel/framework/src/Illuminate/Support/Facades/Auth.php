 ...
 * @method static \Illuminate\Contracts\Auth\Authenticatable|null manager()
 ...
 * @method static void setUserProvider(\Illuminate\Contracts\Auth\UserProvider $provider) * 
 * @method static void setManagerProvider(\Illuminate\Contracts\Auth\ManagerProvider $provider)
...
class Auth extends Facade
{
    ...
    {
        if (! static::$app->providerIsLoaded(PassportServiceProvider::class)) {
